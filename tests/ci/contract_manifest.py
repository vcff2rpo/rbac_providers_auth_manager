...
CONTRACTS: Final[tuple[TestContract, ...]] = (
    ...
    TestContract(
        "tests/ci/test_session_revocation.py",
        "unit",
        "quality",
        capability_tags=("session_revocation", "hot_reload_security"),
    ),
    TestContract(
    ...
    TestContract(
        ...
        "unit",
        "quality",
        capability_tags=("ci_metadata_registry",),
    ),
    TestContract(
        "tests/ci/test_ci_lane_policy.py",
        "unit",
        "quality",
        capability_tags=("ci_lane_policy",),
    ),
    TestContract(
...
CAPABILITY_CATALOG: Final[tuple[dict[str, object], ...]] = (
    ...
    {
        "name": "CI lane policy registry for cadence, blocking, and artifact ownership",
        "tag": "ci_lane_policy",
        "status": "covered",
    },
    {
        "name": "CI metadata registry synchronization",
        "tag": "ci_metadata_registry",
        "status": "covered",
    },
    {
