...
class SecurityConfig:
    ...
    enable_session_revocation_on_sensitive_reload: bool = True
    session_revocation_backend: str = "memory"
    session_revocation_redis_url: str | None = None
    session_revocation_redis_prefix: str = "airflow_auth_revocation"
