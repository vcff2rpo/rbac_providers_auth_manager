...
3. [Current Airflow context](#current-airflow-context)
4. [What plugin does and does not do](#what-plugin-does-and-does-not-do)
5. [High-level architecture](#high-level-architecture)
6. [Package layout and responsibilities](#package-layout-and-responsibilities)
7. [Unified low-level functional mental flow](#unified-low-level-functional-mental-flow)
8. [End-to-end auth and authorization flows](#end-to-end-auth-and-authorization-flows)
9. [Configuration model](#configuration-model)
10. [`permissions.ini` reference](#permissionsini-reference)
11. [Role model and permission semantics](#role-model-and-permission-semantics)
12. [UI behavior and customization](#ui-behavior-and-customization)
13. [Logging, audit, and diagnostics](#logging-audit-and-diagnostics)
14. [Security model](#security-model)
15. [Security interaction mental flows](#security-interaction-mental-flows)
16. [Edge cases and functional scenario catalog](#edge-cases-and-functional-scenario-catalog)
17. [Performance and scalability](#performance-and-scalability)
18. [Comparison with the official FAB auth manager](#comparison-with-the-official-fab-auth-manager)
19. [Operational checklist](#operational-checklist)
20. [Troubleshooting](#troubleshooting)
21. [Known limits and explicit non-goals](#known-limits-and-explicit-non-goals)
22. [Glossary and vocabulary](#glossary-and-vocabulary)
23. [FAQ](#faq)
24. [Contributing and repository collaboration](#contributing-and-repository-collaboration)
