...
LANE_TASKS: dict[str, tuple[LaneTask, ...]] = {
    "quality": (
        ...
        LaneTask(
            ...
            description="Runs the quality-lane pytest families grouped by plugin functionality area with per-family coverage thresholds and scenario-rich API, RBAC mapping, rate-limit, and audit checks.",
        ),
        LaneTask(
            lane="quality",
            task="pip audit",
