...
LANE_TASKS: dict[str, tuple[LaneTask, ...]] = {
    "quality": (
        ...
        LaneTask(
            ...
            description="Runs the quality-lane pytest families grouped by plugin functionality area with per-family coverage thresholds and scenario-rich API, RBAC mapping, role-filter runtime, rate-limit, and audit checks.",
        ),
        LaneTask(
            lane="quality",
            task="pip audit",
    ...
    "deep_validation": (
        ...
        LaneTask(
            ...
            description="Validates configuration loading, permissions.ini variants, role-filter runtime enforcement, runtime defaults, and low-level helper behavior.",
        ),
        LaneTask(
            lane="deep_validation",
            ...
            description="Validates RBAC policy behavior, LDAP/Entra edge-case role mapping, cross-provider isolation, vocabulary drift protection, and static mirror contracts.",
        ),
        LaneTask(
            lane="deep_validation",
